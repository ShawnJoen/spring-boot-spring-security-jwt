...
import com.spring.security.jwt.security.auth.jwt.extractor.TokenExtractor;
import com.spring.security.jwt.security.model.token.RawAccessJwtToken;
...
public class JwtTokenAuthenticationProcessingFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public JwtTokenAuthenticationProcessingFilter(TokenExtractor tokenExtractor, RequestMatcher matcher) {
        super(matcher);
        //this.failureHandler = failureHandler;,AuthenticationFailureHandler failureHandler, RequestMatcher matcher
